import ModulesControls from './ModulesControls';  // Adjust the path if necessary
import LessonControlButtons from './LessonControlButtons';  // Adjust the path as necessary
import ModuleControlButtons from './ModuleControlButtons';  // Adjust the path as necessary
